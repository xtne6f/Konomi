...
if [ $? -eq 0 ]; then
    cpython_tgz_uri='https://github.com/indygreg/python-build-standalone/releases/download/20230116/cpython-3.11.1+20230116-aarch64-unknown-linux-gnu-install_only.tar.gz'
    cpython_sha256=debf15783bdcb5530504f533d33fda75a7b905cec5361ae8f33da5ba6599f8b4
else
    cpython_tgz_uri='https://github.com/indygreg/python-build-standalone/releases/download/20230116/cpython-3.11.1+20230116-x86_64-unknown-linux-gnu-install_only.tar.gz'
    cpython_sha256=02a551fefab3750effd0e156c25446547c238688a32fabde2995c941c03a6423
fi
pypenv_version=2023.4.29

tsreadex_src_uri='https://github.com/xtne6f/tsreadex/archive/fd72ef31b94832ee8e761800f9f5d5a8e66c8a22.tar.gz'
...
if [ -e Python ]; then
    ...
    ./Python/bin/python -m pip install pipenv==$pypenv_version
    echo 'Done.'
fi
