...
if [ $? -eq 0 ]; then
    cpython_tgz_uri='https://github.com/indygreg/python-build-standalone/releases/download/20240814/cpython-3.11.9+20240814-aarch64-unknown-linux-gnu-install_only.tar.gz'
    cpython_sha256=c74a3313e081dda8360d1824baa4eae5303333555bf8440ec2de521731e39165
else
    cpython_tgz_uri='https://github.com/indygreg/python-build-standalone/releases/download/20240814/cpython-3.11.9+20240814-x86_64-unknown-linux-gnu-install_only.tar.gz'
    cpython_sha256=9a332ba354f3b4e8a96a15db6b2805a7a31dcc1b6b9c1b7b93e5246949fbb50f
fi
