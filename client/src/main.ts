...
import fluentAdd16Filled from '@iconify-icons/fluent/add-16-filled';
...
import fluentArrowDownload24Regular from '@iconify-icons/fluent/arrow-download-24-regular';
import fluentArrowSync20Filled from '@iconify-icons/fluent/arrow-sync-20-filled';
import fluentBookArrowClockwise20Regular from '@iconify-icons/fluent/book-arrow-clockwise-20-regular';
...
import fluentChevronRight12Regular from '@iconify-icons/fluent/chevron-right-12-regular';
...
import fluentClock12Regular from '@iconify-icons/fluent/clock-12-regular';
...
import fluentDocument20Filled from '@iconify-icons/fluent/document-20-filled';
...
import fluentFilter16Filled from '@iconify-icons/fluent/filter-16-filled';
import fluentFolderSync20Regular from '@iconify-icons/fluent/folder-sync-20-regular';
...
import fluentImageArrowCounterclockwise24Regular from '@iconify-icons/fluent/image-arrow-counterclockwise-24-regular';
...
import fluentSpeaker220Filled from '@iconify-icons/fluent/speaker-2-20-filled';
...
import fluentVideo20Filled from '@iconify-icons/fluent/video-20-filled';
import fluentVideoClip20Filled from '@iconify-icons/fluent/video-clip-20-filled';
...
addIcon('fluent:add-16-filled', fluentAdd16Filled);
...
addIcon('fluent:arrow-download-24-regular', fluentArrowDownload24Regular);
addIcon('fluent:arrow-sync-20-filled', fluentArrowSync20Filled);
addIcon('fluent:book-arrow-clockwise-20-regular', fluentBookArrowClockwise20Regular);
...
addIcon('fluent:chevron-right-12-regular', fluentChevronRight12Regular);
...
addIcon('fluent:clock-12-regular', fluentClock12Regular);
...
addIcon('fluent:document-20-filled', fluentDocument20Filled);
...
addIcon('fluent:filter-16-filled', fluentFilter16Filled);
addIcon('fluent:folder-sync-20-regular', fluentFolderSync20Regular);
...
addIcon('fluent:image-arrow-counterclockwise-24-regular', fluentImageArrowCounterclockwise24Regular);
...
addIcon('fluent:speaker-2-20-filled', fluentSpeaker220Filled);
...
addIcon('fluent:video-20-filled', fluentVideo20Filled);
addIcon('fluent:video-clip-20-filled', fluentVideoClip20Filled);
...
addIcon('line-md:loading-twotone-loop', lineMdLoadingTwotoneLoop);
